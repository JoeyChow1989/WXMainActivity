...
public class YqhyDialog2 extends PopupWindow implements OnClickListener {
	...
	public void initView() {
		...
		wx_py_image = (ImageView) rootView.findViewById(R.id.wx_py_image2);
		wx_py_image.setOnClickListener(this);
		wx_image = (ImageView) rootView.findViewById(R.id.wx_image2);
		wx_image.setOnClickListener(this);
		wx_py_text = (TextView) rootView.findViewById(R.id.wx_py_text2);
		wx_py_text.setOnClickListener(this);
		wx_text = (TextView) rootView.findViewById(R.id.wx_text2);
		wx_text.setOnClickListener(this);
		main_textLayout = (LinearLayout) rootView.findViewById(R.id.main_linearlayout2);
